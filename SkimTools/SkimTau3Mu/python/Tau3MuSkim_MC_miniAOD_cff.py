...
Tau3MuHLTFilter.HLTPaths = ["HLT_DoubleMu3_Trk_Tau3mu*", "HLT_DoubleMu3_TkMu_DsTau3Mu_v*", "HLT_DoubleMu3_Trk_Tau3mu_NoL1Mass_v*", "HLT_Tau3Mu_Mu7_Mu1_TkMu1_IsoTau15_Charge1"]
...
looseMuons = cms.EDFilter("PATMuonSelector",
                          ...
                          #changed filter for MC UL 2017!!!!
                          cut = cms.string('pt > 1.5 &&  abs(eta)<2.4 && (innerTrack().isNonnull) && (charge!=0) && (innerTrack().hitPattern().numberOfValidPixelHits()>0)'), 
